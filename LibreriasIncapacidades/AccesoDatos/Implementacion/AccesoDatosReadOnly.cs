...
namespace LibreriasIncapacidades.AccesoDatos
{
    public class AccesoDatosReadOnly : IAccesoDatosReadOnly
    {
        ...
        public Incapacidad Consultar_Incapacidad(string id_incapacidad)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var incapacidad = DapperWrapper.Query<Incapacidad>(connection, "dbo.Consultar_Incapacidad",
                                    new { id_incapacidad = id_incapacidad }, commandType: CommandType.StoredProcedure);
                return incapacidad.FirstOrDefault();
            };
        }
        ...
        public IList< RegistroConceptoRehabilitacion> Consultar_TodosListasConsultarConceptos(Paciente pacienteCR)
        {
            ...
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listaConceptos = connection.Query<RegistroConceptoRehabilitacion, Concepto_Rehabilitacion, Diagnostico, DiagnosticoRelacionUno, DiagnosticoRelacionDos, Origen, RegistroConceptoRehabilitacion>("dbo.Consultar_Concepto_Rehabilitacion_Paciente",
                    map: (registroCR, concepto, diagnosticoPrincipal, diagnostico1, diagnostico2, origen) =>
                    {
                        registroCR.concepto_rehabilitacion = concepto;
                        registroCR.diagnostico = diagnosticoPrincipal;
                        registroCR.diagnosticoRelacionUno = diagnostico1;
                        registroCR.diagnosticoRelacionDos = diagnostico2;
                        registroCR.origen = origen;
                        return registroCR;
                    },
                    param: new
                    {
                    ...
                    splitOn: "concepto_rehabilitacion, id_diagnosticos, id_diagnostico_uno, id_diagnostico_dos, id_origen",
                    commandType: CommandType.StoredProcedure);


                return listaConceptos.ToList();
            };
        }
        ...
        public RelacionPacienteAfiliacionSalud Consultar_RelacionPacienteAfiliacionSalud(long idPaciente)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var relacionPacienteAfiliacionSalud = DapperWrapper.Query<RelacionPacienteAfiliacionSalud>(connection, "dbo.Consultar_RelacionPacienteAfiliacionSalud",
                    new { parametro = idPaciente }, CommandType.StoredProcedure);
        ...
        public IList<RelacionPacienteAportante> Consultar_RelacionPacienteAportante(string id_incapacidad)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var relacionPacienteAportante = DapperWrapper.Query<RelacionPacienteAportante>(connection, "dbo.Consultar_RelacionPacienteAportante",
                    new { parametro = id_incapacidad },
                    CommandType.StoredProcedure);
                return relacionPacienteAportante.ToList();
            };
        }
        ...
        public IList<PerdidaCapacidadLaboral> Consultar_PerdidaCapacidadLaboral(Int64 id_concepto_registro)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var perdidaCapacidadLaboral = DapperWrapper.Query<PerdidaCapacidadLaboral>(connection, "dbo.Consultar_Perdidas_Incapacidad_Laboral",
                    new { id_concepto_registro = id_concepto_registro },
                    CommandType.StoredProcedure);
                return perdidaCapacidadLaboral.ToList();
            };
        }


        public IList<NotificarIncapacidadDTO> Consultar_Notificar_Incapacidad(NotificarIncapacidadDTO incapacidad)
        {            
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listnotificar = DapperWrapper.Query<NotificarIncapacidadDTO>(connection, "dbo.Notificar_Incapacidad",
                    param: new
                    {
                        @id_incapacidad = incapacidad.id_incapacidad,
                    ...
                    CommandType.StoredProcedure);
                return listnotificar.ToList();
            };           
        }

        public IList<NotificarIncapacidadDTO> Consultar_Notificar_Incapacidad_180_540(NotificarIncapacidadDTO incapacidad)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listnotificar = DapperWrapper.Query<NotificarIncapacidadDTO>(connection, "dbo.Notificar_Incapacidad_180_540",
                    param: new
                    {
                        @id_incapacidad = incapacidad.id_incapacidad,
                        @id_origen = incapacidad.id_origen,
        ...
        public IList<NotificarIncapacidadPagadaDTO> Consultar_Notificar_Incapacidad_Pagada(NotificarIncapacidadPagadaDTO incapacidad)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listnotificar = DapperWrapper.Query<NotificarIncapacidadPagadaDTO>(connection, "dbo.Notificar_Incapacidad_Pagada",
                    param: new
                    {
                        @id_incapacidad = incapacidad.id_incapacidad,
                    },
        ...
        public IList<NotificarIncapacidadDTO> GetNotificar_IncapacidadAnulada(NotificarIncapacidadDTO incapacidad)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listnotificar = DapperWrapper.Query<NotificarIncapacidadDTO>(connection, "dbo.Notificar_IncapacidadAnulada",
                    param: new
                    {
                        @id_incapacidad = incapacidad.id_incapacidad,
                        @id_origen = incapacidad.id_origen,
        ...
        public IList<NotificarIncapacidadDTO> GetNotificar_IncapacidadARehabilitacion(NotificarIncapacidadDTO incapacidad)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listnotificar = DapperWrapper.Query<NotificarIncapacidadDTO>(connection, "dbo.Notificar_IncapacidadRehabilitacion",
                    param: new
                    {
                        @id_incapacidad = incapacidad.id_incapacidad,
                        @id_origen = incapacidad.id_origen,
        ...
        public IList<RegistroConceptoRehabilitacion> GetIncapacidadARehabilitacion(Incapacidad incapacidad)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listnotificar = DapperWrapper.Query<RegistroConceptoRehabilitacion>(connection, "dbo.RehabilitacionByIdIncapacidad",
                    param: new
                    {
                        @id_incapacidad = incapacidad.id_incapacidad
                    },
        ...
        public IList<RegistrarPago> Consultar_Incapacidad_Pagada(RegistrarPago registroPago)
        {
            using (var connection = ConexionFactory.CrearConexion(EnumConexion.ReadOnly))
            {
                var listaRegistros = DapperWrapper.Query<RegistrarPago>(connection, "dbo.Consultar_Incapacidad_Con_Pago",
                    new { 
                            id_incapacidad = registroPago.id_incapacidad,
                            tipo_documento_aportante = registroPago.tipo_documento_aportante,
                            numero_documento_aportante = registroPago.numero_documento_aportante
                    },
                    CommandType.StoredProcedure);
