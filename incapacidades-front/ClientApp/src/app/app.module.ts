...
import { ServerErrorInterceptor } from './component/utilidades/server-error.interceptor';
...
import { ActualizacionDatosComponent } from './component/actualizacion-datos/actualizacion-datos.component';
...
@NgModule({
  ...
  imports: [
    BrowserModule, FormsModule, HttpClientModule, AngularFormsInputMasksModule, ReactiveFormsModule,
    RouterModule, AppRoutingModule, BrowserAnimationsModule , NgbModule, 
