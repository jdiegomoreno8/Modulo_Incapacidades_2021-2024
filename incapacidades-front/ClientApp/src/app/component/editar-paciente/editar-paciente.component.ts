...
export class EditarPacienteComponent implements OnInit {
  ...
  async ngOnInit(){
    ...
    //console.log(this.fechaMinimaNacimiento);
  ...
  async ActualizarValoresFormulario(pac:IPacienteModel){
    ...
    //console.log(this.f_paciente.id_regimen.value );
    ...
    console.log(this.listaAdministradorasByCodRegimen );
    console.log('listaAdministradoras cargada con exito');
  }
...
async abrirModalConfirmacionPaciente(modeloPaciente: IPacienteModel) { 
    ...
    this.pacienteIn.primer_nombre= this.f_paciente.primer_nombre.value;
    this.pacienteIn.segundo_nombre= this.f_paciente.segundo_nombre.value;
    this.pacienteIn.primer_apellido= this.f_paciente.primer_apellido.value;
    this.pacienteIn.segundo_apellido= this.f_paciente.segundo_apellido.value;
 ...
 public changeValueTipoDocumento() {
  ...
  async cargarListas() {  
    ...
    console.log('listaRegimen cargada con exito');
    ...
    console.log('listaSexo cargada con exito');
    ...
    // console.log('listaAdministradoras cargada con exito');
    //console.log(this.listaAdministradoras)
