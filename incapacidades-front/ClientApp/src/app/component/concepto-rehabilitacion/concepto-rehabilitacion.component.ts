...
/*      numeroIncapacidad: ['', Validators.required],*/
  ...
  async buscarIncapacidad(contenidoIncapacidad) {
    try {
      ...
      this.conceptoExistente = await this.parametrosIncapacidadesService.post('/ConceptoRehabilitacion/ConsultarCRPorPaciente', this.pacienteGet);
      console.log(this.conceptoExistente);

      this.incapacidadesResult = await this.parametrosIncapacidadesService.post('/ConceptoRehabilitacion/ConsultaIncapacidadCR', this.pacienteGet);
...
/*        event.preventDefault();*/
  ...
  async confirmarConcepto() {
    try {
      ...
      this.ConceptoResult = await this.parametrosIncapacidadesService.post('/ConceptoRehabilitacion/GuardarConceptoRehabilitacion', this.conceptoRegistro);
 ...
 /*     console.log("df");*/
  ...
  async openModalCR(contenido) {
    ...
    if (this.medico.tipo_documento != '' && this.medico.numero_documento != '') {
      this.medicoResult = await this.parametrosIncapacidadesService.post('/ConsultaMedico/ConsultaMedicoRethus', this.medico);
